/*
Program Title : PayRole Mangement System
Programmers    : Sushmitha Tilak Manjunatha
E-Mail	      : manjusai68@gmail.com
*/
  ...
  void dev()
 {
  clrscr();
   for(int x=50;x>=20;x--)
	...
	gotoxy(x,16);
	cputs("Tilak Sushmitha Manjunatha");
